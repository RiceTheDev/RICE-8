        ...
        if (screenState == 0){
            ...
            BeginTextureMode(screen);
                ...
                if (newScreenWidth != currentScreenWidth || newScreenHeight != currentScreenHeight) {
                    ...
                    screen = LoadRenderTexture(newScreenWidth, newScreenHeight);
                    SetTextureFilter(screen.texture, TEXTURE_FILTER_POINT);
                ...
                BeginTextureMode(screen);
                    ...
                    ImGui::Begin("editor de text poggers do rice",
                        nullptr,
                        ImGuiWindowFlags_NoTitleBar |
                        ImGuiWindowFlags_NoResize |
                        ImGuiWindowFlags_NoMove |
                        ImGuiWindowFlags_NoCollapse
                        // | ImGuiWindowFlags_NoBackground // Uncomment for transparent background
                    );
                    set_theme();
                    editor.Render("editor de text poggers do rice");
                    
                    ImGui::End();
                    
                    DrawRectangle(0, 0, currentScreenWidth, 30, Color { 33, 33, 33, 255 });
                    DrawLine(0, 30, currentScreenWidth, 30, Color {20, 20, 20, 255});
                    DrawLine(0, 31, currentScreenWidth, 31, Color {20, 20, 20, 255});
                    DrawLineEx((Vector2){150, 0}, (Vector2){150, 30}, 2, Color {20, 20, 20, 255});
                    DrawLineEx((Vector2){300, 0}, (Vector2){300, currentScreenHeight}, 2, Color {20, 20, 20, 255});
                ...
                BeginDrawing();
                    ...
                    DrawTextureEx(drawing_icon, Vector2 {25 * scale, 0}, 0, 1.8f * scale, WHITE);
                    DrawTextureEx(code_icon, Vector2 {250 * ((float)GetScreenWidth() / currentScreenWidth), 0}, 0, 1.8f * scale, WHITE);
                    DrawTextEx(font, "Draw", Vector2 {60 * scale, 3 * scale}, 22 * scale, 0, WHITE);
                    DrawTextEx(font, "Code", Vector2 {190 * ((float)GetScreenWidth() / currentScreenWidth), 3 * scale}, 22 * scale, 0, WHITE);
                EndDrawing();
            }
        }
